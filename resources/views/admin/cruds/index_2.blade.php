                ...
                <div class="card card-custom gutter-b card-stretch bg-light">
                    ...
                    <div class="card-body d-flex flex-column" style="position: relative;">
                            ...
                            <div class="row row-paddingless mb-10">
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center mr-2">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="font-size-h4 text-dark-75 font-weight-bold">{{$count->chapters}}</div>
                                            <div class="font-size-sm text-muted font-weight-bold mt-1">Chapters</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                </div>
                        ...
                        <div class="m-auto">
                             ...
                             <a href="{{route('admin.subjects.show',$row->id)}}" class="btn btn-sm btn-icon btn-success">
                                 <i class="flaticon2-analytics-2"></i>
                             </a>
                             <a href="{{route('admin.subjects.edit',$row->id)}}" class="btn btn-sm btn-icon btn-warning">
                                 <i class="flaticon2-pen"></i>
                             </a>
                             <a onclick="Delete('{{route('admin.subjects.destroy',$row->id)}}')" class="btn btn-sm btn-icon btn-danger">
