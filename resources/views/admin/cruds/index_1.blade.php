...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        ...
        <div class="card-toolbar">
            ...
            <div class="dropdown dropdown-inline">
                <a href="#" class="btn btn-light-warning font-weight-bold dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
    ...
    <div class="card-body pt-0 pb-3">
                ...
                <div class="card card-custom gutter-b card-stretch bg-light">
                        ...
                        <div class="card-title font-weight-bold">
                            <div class="card-label">{{$row->title}}
                                <div class="font-size-sm text-muted mt-2">
                                    ...
                                    @else
                                    <span class="label label-light-danger label-inline">Deactive</span>
                                    @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body d-flex flex-column" style="position: relative;">
                            ...
                            <div class="row row-paddingless mb-10">
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center mr-2">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="font-size-h4 text-dark-75 font-weight-bold">{{$count->orders}}</div>
                                            <div class="font-size-sm text-muted font-weight-bold mt-1">Orders</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center mr-2">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="font-size-h4 text-dark-75 font-weight-bold">{{$count->subjects}}</div>
                                            <div class="font-size-sm text-muted font-weight-bold mt-1">Subjects</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                </div>
                            ...
                            <div class="row row-paddingless">
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center mr-2">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="font-size-h4 text-dark-75 font-weight-bold">{{$count->exams}}</div>
                                            <div class="font-size-sm text-muted font-weight-bold mt-1">Exams</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center mr-2">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="font-size-h4 text-dark-75 font-weight-bold">{{$count->videos}}</div>
                                            <div class="font-size-sm text-muted font-weight-bold mt-1">Videos</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                </div>
                        ...
                        <div class="m-auto">
                             ...
                             <a href="{{route('admin.courses.show',$row->id)}}" class="btn btn-sm btn-icon btn-success">
                                 <i class="flaticon2-analytics-2"></i>
                             </a>
                             <a href="{{route('admin.courses.edit',$row->id)}}" class="btn btn-sm btn-icon btn-warning">
                                 <i class="flaticon2-pen"></i>
                             </a>
                             <a onclick="Delete('{{route('admin.courses.destroy',$row->id)}}')" class="btn btn-sm btn-icon btn-danger">
       ...
       {{ $data->appends(request()->input())->links('paginate.default') }}
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-bottom text-right">
                            <button type="button" class="btn btn-light-success font-weight-bold btn-sm mr-3 font-size-lg" data-dismiss="modal">Cancel</button>
                            <button type="submit" class="btn btn-danger font-weight-bold btn-sm mr-10 font-size-lg">Delete</button>
                        </div>
