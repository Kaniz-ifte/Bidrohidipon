...
<html lang="en">
	...
	<head>
		...
		<link href="{{asset('css/pages/login/classic/login-5.css?v=7.0.5')}}" rel="stylesheet" type="text/css" />
						...
						<div class="login-signin">
							...
							<form class="form" id="kt_login_signin_form" method="POST" action="{{ route('admin.login.submit') }}">
								...
								<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
									<input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="text" placeholder="Email" name="email" value="{{ old('email') }}" required autofocus/>
                                             @if ($errors->has('email'))
								...
								<div class="form-group d-flex flex-wrap justify-content-between align-items-center px-8 opacity-60">
									...
									<a href="{{route('admin.password.request')}}" id="kt_login_forgot" class="text-white font-weight-bold">Forget Password ?</a>
								</div>
