            ...
            <div class="col-xl-4 float-left">
                ...
                <div class="card card-custom gutter-b card-stretch bg-light">
                    ...
                    <div class="card-body d-flex flex-column" style="position: relative;">
                        ...
                        <!--begin::Items-->
                        <div class="">
                            <div class="row row-paddingless mb-5">

                                @php
                                $count=CountBySubject($row->id);
                                @endphp
                        ...
                        <div class="row row-paddingless m-auto text-center">
                            <button class="btn btn-outline-success btn-block my-5">{{$row->course_title}}
                            </button>
                        </div>

                        <div class="m-auto">

                            <a href="{{route('admin.chapters.show',$row->id)}}" class="btn btn-sm btn-icon btn-success">
                                <i class="flaticon2-analytics-2"></i>
                            </a>
                            <a href="{{route('admin.chapters.edit',$row->id)}}" class="btn btn-sm btn-icon btn-warning">
                                <i class="flaticon2-pen"></i>
                            </a>
                            <a onclick="Delete('{{route('admin.chapters.destroy',$row->id)}}')" class="btn btn-sm btn-icon btn-danger">
