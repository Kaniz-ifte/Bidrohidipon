...
class StillController extends Controller
{
    ...
    function __construct()
    {
         ...
         $this->key_word='Still';
         $this->key_word_plural='Stills';
         $this->route_index='admin.stills.index';
         $this->route_create='admin.stills.create';
         $this->route_edit='admin.stills.edit';
         $this->route_update='admin.stills.update';
         $this->route_destroy='admin.stills.destroy';
         $this->route_store='admin.stills.store';
    }
    ...
    public function index(Request $request)
    {
        ...
        $data = Still::orderBy('id','DESC')->paginate($perPage);
    ...
    public function store(Request $request)
    {
        ...
        $row = new Still($request->except(['_token','banner']));
