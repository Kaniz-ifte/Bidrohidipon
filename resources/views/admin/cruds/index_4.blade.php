                            ...
                            <div class="card-label">{{$row->title}}
                                <div class="font-size-sm text-muted mt-2">
                                    {{$row->chapter_title}}
                                     ...
                                     <span class="label label-light-success label-inline">Youtube</span>
                                     @else
                                     <span class="label label-light-danger label-inline">Vimeo</span>
                                     @endif
                                </div>
                            </div>
                        </div>
...
{{--
                        ...
                        <div class="row row-paddingless m-auto text-center">
                            <button class="btn btn-outline-success btn-block my-5">{{$row->subject_title}}
                            </button>
                        </div> --}}

                        <div class="m-auto">

                            <a href="{{route('admin.videos.show',$row->id)}}" class="btn btn-sm btn-icon btn-success">
                                <i class="flaticon2-analytics-2"></i>
                            </a>
                            <a href="{{route('admin.videos.edit',$row->id)}}" class="btn btn-sm btn-icon btn-warning">
                                <i class="flaticon2-pen"></i>
                            </a>
                            <a onclick="Delete('{{route('admin.videos.destroy',$row->id)}}')" class="btn btn-sm btn-icon btn-danger">
