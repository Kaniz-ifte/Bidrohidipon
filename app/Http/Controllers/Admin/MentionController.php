...
class MentionController extends Controller
{
    ...
    function __construct()
    {
         ...
         $this->key_word='Mention';
         $this->key_word_plural='Mentions';
         $this->route_index='admin.mentions.index';
         $this->route_create='admin.mentions.create';
         $this->route_edit='admin.mentions.edit';
         $this->route_update='admin.mentions.update';
         $this->route_destroy='admin.mentions.destroy';
         $this->route_store='admin.mentions.store';
    }
    ...
    public function index(Request $request)
    {
        ...
        $data = Mention::orderBy('id','DESC')->paginate($perPage);
    ...
    public function create()
    {
        ...
        $info->form_inputs=[
             ...
             [
                   "title"=>"Banner:",
                   "id"=>'image_1',
                   "sample_image"=>'media/sample/still.jpg',
    ...
    public function store(Request $request)
    {
        ...
        $row = new Mention($request->except(['_token','banner']));
    ...
    public function edit($id)
    {
          ...
          $data=Mention::where('id',$id)->first();
