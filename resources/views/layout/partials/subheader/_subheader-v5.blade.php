    ...
    <div class="{{ Metronic::printClasses('subheader-container', false) }} d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center">
                         ...
                         <a href="#" class="btn btn-light-success font-weight-bolder btn-sm mr-2">
                             <i class="ki ki-plus icon-1x"></i> Add New
                         </a>
            ...
            <div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
                <a href="#" class="btn btn-light-success font-weight-bolder btn-sm mr-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
